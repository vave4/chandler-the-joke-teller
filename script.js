...
function tellMe(joke) {
     ...
     VoiceRSS.speech({
            key: '71aca0d48bb040ec8dbc547cac0cfa72',
            src: joke,
            hl: 'en-us',
            v: 'Linda',
            r: 0, 
...
async function getJokes() {
     let joke = "";
     const apiUrl = "https://v2.jokeapi.dev/joke/Programming,Miscellaneous,Dark,Pun,Spooky,Christmas?blacklistFlags=nsfw,religious,racist,sexist";
     try {
